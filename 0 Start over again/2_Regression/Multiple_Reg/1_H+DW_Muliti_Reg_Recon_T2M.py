...
for ilat in range(91):
    for ilon in range(360):
        ...
        T2M_Recon_21[ilat, ilon] = linreg.predict(X_0[42,:].reshape(1, -1))
        T2M_Recon_22[ilat, ilon] = linreg.predict(X_0[43,:].reshape(1, -1))
...
def drawing_T2M(cyclic_data1, cyclic_data2, name1, name2):
    ...
    plt.savefig(r'F:\6_Scientific_Research\3_Teleconnection\0 Start over again\1_Picture\2_Reg_Recon-Pred\Multi_Reg_Reconstruct-T2M-2021-2022.png')
    plt.show()
