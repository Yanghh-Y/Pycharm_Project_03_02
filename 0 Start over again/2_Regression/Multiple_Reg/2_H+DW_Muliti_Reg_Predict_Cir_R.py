...
Cir_R_Predict_21,Cir_R_Predict_22 = np.zeros((37, 144)), np.zeros((37, 144))
# --- 提取线性分量 --- #
...
for ilat in range(37):
    for ilon in range(144):
        ...
        Cir_R_Predict_21[ilat, ilon] = linreg2021.predict(X_0[42,:].reshape(1, -1))
        ...
        Cir_R_Predict_22[ilat, ilon] = linreg2022.predict(X_0[43,:].reshape(1, -1))


# --- Drawing - Contourf --- #
# -- Data - Pre-Process -- #
Cir_R_Recon_21 = Cir_R_Predict_21 + Cir_R_linear_2021
Cir_R_Recon_22 = Cir_R_Predict_22 + Cir_R_linear_2022
...
def drawing_Z(cyclic_data1, cyclic_data2, name1, name2):
    ...
    plt.savefig(r'F:\6_Scientific_Research\3_Teleconnection\0 Start over again\1_Picture\2_Reg_Recon-Pred\Muliti-Reg-Predict-Cir_R-2021-2022.png')
    plt.show()
drawing_Z(Cir_R_Recon_21c, Cir_R_Recon_22c, name1='Predict-21', name2='Predict-22')
