...
for ilat in range(91):
    for ilon in range(360):
        ...
        try:
            ...
            SAT_Recon_21[ilat, ilon], SAT_Recon_22[ilat, ilon] = yFit[42], yFit[43]
        except:
            tuple = (ilat, ilon)
...
def drawing_SAT(cyclic_data1, cyclic_data2, name1, name2):
    ...
    plt.savefig(r'F:\6_Scientific_Research\3_Teleconnection\0 Start over again\1_Picture\2_Reg_Recon-Pred\Step-Reg-Reconstruct-SAT-2021-2022.png')
    plt.show()
