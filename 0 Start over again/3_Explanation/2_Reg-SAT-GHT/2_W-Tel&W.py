...
def drawingcount(Data, P, abc):
    for nrow in range(7):
        ...
        ax_cf1 = axs2[nrow].contourf(clons, lat, Data[nrow,:,:], transform=ccrs.PlateCarree(), zorder=0, cmap='coolwarm', levels=np.arange(-0.10, 0.12, 0.02), extend='both')
    ...
    fig.savefig(r'F:\6_Scientific_Research\3_Teleconnection\0 Start over again\1_Picture\3_Explanation\2_Reg\reg_W-tel_Cir_W.png')
    plt.show()
