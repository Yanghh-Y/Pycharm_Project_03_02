...
Air_cli_mean = Air_Sum_Mean.loc['1981':'2000'].mean(dim='year')
Air_19_ano = Air_Sum_Mean.sel(year=2019) - Air_cli_mean
Air_20_ano = Air_Sum_Mean.sel(year=2020) - Air_cli_mean
...
def drawing(cyclic_data1, cyclic_data2):
    ...
    # 图名
    ax1.set_title('SAT anomalies in 2019')
    ax2.set_title('SAT anomalies in 2020')
    # 刻度线形式
