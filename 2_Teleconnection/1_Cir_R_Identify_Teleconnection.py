...
ds = xr.Dataset({'r': r})
ds.to_netcdf(r'F:\6_Scientific_Research\3_Teleconnection\1_Data\R_P\Cir_R_r_all_lon_lat.nc')
p = xr.DataArray(p, coords=[ilat, ilon, dlat, dlon], dims=['ilat', 'ilon', 'dlat', 'dlon'])
dp = xr.Dataset({'p': p})
dp.to_netcdf(r'F:\6_Scientific_Research\3_Teleconnection\1_Data\R_P\Cir_R_p_all_lon_lat.nc')
