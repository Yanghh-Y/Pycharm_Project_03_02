...
#--读取数据--#
# 相关系数以及P值筛选
f1 = xr.open_dataset(r'F:\6_Scientific_Research\3_Teleconnection\1_Data\R_P\Cir_H_r_all_lon_lat.nc')
f2 = xr.open_dataset(r'F:\6_Scientific_Research\3_Teleconnection\1_Data\R_P\Cir_H_p_all_lon_lat.nc')
...
# ds.to_netcdf(r'F:\6_Scientific_Research\3_Teleconnection\1_Data\R_P\cir_H_r_min_arr.nc')
...
# Point_df.to_csv(r'F:\6_Scientific_Research\3_Teleconnection\1_Data\R_P\Cir_H_Point.csv', )
...
def drawing(cyclic_lons, lat, cyclic_data):
    ...
    # 填充等值线和添加等值线、colobar
    ax_cf1 = ax.contourf(cyclic_lons, lat, cyclic_data, zorder=0, extend='both', transform=ccrs.PlateCarree(), cmap='hot', levels=np.arange(-0.8, -0.45, 0.05 ))  # 绘制等值线图
    # 添加colorbar
    ...
    # plt.savefig(r'F:\6_Scientific_Research\3_Teleconnection\2_Picture\2_Teleconnection\Cir_H_Teleconnectivity matrix.png')
    plt.show()
