...
#--读取数据--#
# 相关系数以及P值筛选
f1 = xr.open_dataset(r'F:\6_Scientific_Research\3_Teleconnection\1_Data\R_P\Cir_R_r_all_lon_lat.nc' ,engine='netcdf4')
f2 = xr.open_dataset(r'F:\6_Scientific_Research\3_Teleconnection\1_Data\R_P\Cir_R_p_all_lon_lat.nc')
...
# ds.to_netcdf(r'F:\6_Scientific_Research\3_Teleconnection\1_Data\R_P\cir_R_r_min_arr.nc')
...
# Point_df.to_csv(r'F:\6_Scientific_Research\3_Teleconnection\1_Data\R_P\Cir_R_Point.csv', )
...
def drawing(cyclic_lons, lat, cyclic_data):
    ...
    # 填充等值线和添加等值线、colobar
    ax_cf1 = ax.contourf(cyclic_lons, lat, cyclic_data, zorder=0, extend='both', transform=ccrs.PlateCarree(), cmap='hot', levels=np.arange(-0.42, 0.03, 0.03 ))  # 绘制等值线图
    # 添加colorbar
