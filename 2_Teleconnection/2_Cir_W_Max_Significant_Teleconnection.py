...
#--读取数据--#
# 相关系数以及P值筛选
f1 = xr.open_dataset(r'F:\6_Scientific_Research\3_Teleconnection\1_Data\R_P\Cir_W_r_all_lon_lat.nc' ,engine='netcdf4')
f2 = xr.open_dataset(r'F:\6_Scientific_Research\3_Teleconnection\1_Data\R_P\Cir_W_p_all_lon_lat.nc')
...
# ds.to_netcdf(r'F:\6_Scientific_Research\3_Teleconnection\1_Data\R_P\cir_W_r_min_arr.nc')
...
# Point_df.to_csv(r'F:\6_Scientific_Research\3_Teleconnection\1_Data\R_P\Cir_W_Point.csv', )
...
def drawing(cyclic_lons, lat, cyclic_data):
    ...
    plt.savefig(r'F:\6_Scientific_Research\3_Teleconnection\2_Picture\2_Teleconnection\Cir_W_Teleconnectivity matrix.png')
    plt.show()
