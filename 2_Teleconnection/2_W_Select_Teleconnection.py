...
f1 = xr.open_dataset(r'F:\6_Scientific_Research\3_Teleconnection\1_Data\R_P\cir_W_r_min_arr.nc', engine="netcdf4")
...
ax_cf1 = ax1.contourf(cyclic_lons, lat, R, transform=ccrs.PlateCarree(), cmap='hot',
                      levels=np.arange(-0.6, 0.2, 0.025 ), extend='both')  # 绘制等值线图
