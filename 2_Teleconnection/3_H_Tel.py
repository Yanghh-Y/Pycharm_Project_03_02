...
R = f1.r_min_r
R = R.fillna(0.4)
Df = pd.read_csv(r'F:\6_Scientific_Research\3_Teleconnection\1_Data\Teleconnection\H_Teleconnection.csv')
...
# for i in range(5):
#     ax1.plot([Df.loc[i,'Point1_lon'], Df.loc[i, 'Point2_lon']], [Df.loc[i,'Point1_lat'], Df.loc[i, 'Point2_lat']],'b', '^',transform=ccrs.PlateCarree(), linewidth=1)
...
plt.savefig(r'F:\6_Scientific_Research\3_Teleconnection\2_Picture\2_Teleconnection\Cir_H_Teleconnectivity matrix_0.png')
