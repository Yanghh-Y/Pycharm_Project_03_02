...
def drawing_SAT(cyclic_data1, cyclic_data2, name1, name2):
    ...
    # 图名
    ax1.set_title('H+W_Stepwise_linear'+str(name1))
    ax2.set_title('H_W_Stepwise_linear'+str(name2))
    # 刻度线形式
    ...
    plt.savefig(r'F:\6_Scientific_Research\3_Teleconnection\2_Picture\3_Pred\H+W_Stepwise_linear_regression'+str(name1)+'_'+str(name2)+'.png')
