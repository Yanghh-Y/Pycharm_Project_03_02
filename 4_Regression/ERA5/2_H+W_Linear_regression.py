...
def drawing_SAT(cyclic_data1, cyclic_data2, Name1, Name2):
    ...
    # 图名
    ax1.set_title('ERA5_H+W_MLR_'+str(Name1)+'2021-1000hPa-Tem')
    ax2.set_title('ERA5_H+W_MLR_'+str(Name2)+'2022-1000hPa-Tem')
    ...
    plt.savefig(r'F:\6_Scientific_Research\3_Teleconnection\2_Picture\3_Pred\2_era5\'ERA5_H+W_MLR_'+str(Name1)+'-2021-2022-1000hPa-Tem.png')
    plt.show()
