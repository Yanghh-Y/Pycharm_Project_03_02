...
#--读取数据--#
# 读取遥相关指数
WTELIS = pd.read_csv(r'F:\6_Scientific_Research\3_Teleconnection\1_Data\Teleconnection\WI.csv', usecols=['A1A2', 'A1A3', 'B1B2', 'B1B3', 'C1C2', 'C1C3', 'E1E2', 'E1E3'])
HTELIS = pd.read_csv(r'F:\6_Scientific_Research\3_Teleconnection\1_Data\Teleconnection\HI.csv', usecols=['B1B2', 'C1C2', 'D1D2', 'E1E2', 'F1F2'])
...
fig.savefig(r'F:\6_Scientific_Research\3_Teleconnection\2_Picture\4_Explanation\Cor_H-TEL_W-TEL.png')
