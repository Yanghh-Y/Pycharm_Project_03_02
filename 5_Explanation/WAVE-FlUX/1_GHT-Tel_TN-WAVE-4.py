...
Ψ_prim_detrend = scipy.signal.detrend(Ψ_prim[1:, :, :], axis=0, type='linear', overwrite_data=False) # Ψ_prim_detrend[36, 144, 70]
Ψ_prim_year_mean = Ψ_prim.mean(2) # Ψ_prim_year_mean[37, 144]
for iyear in range(70):
    Ψ_prim[1: ,:, iyear] = Ψ_prim_detrend[:, :, iyear] + Ψ_prim_year_mean[1:, :]
# 扰动准地转流函数的回归
...
ax.quiver(lon[::2], lat[::2], fx[::2,::2], fy[::2,::2], wind_climatic[::2,::2], transform=ccrs.PlateCarree(), scale=0.002, cmap=plt.cm.jet)
