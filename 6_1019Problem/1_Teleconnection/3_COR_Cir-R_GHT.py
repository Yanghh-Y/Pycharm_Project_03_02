...
# 选时间，高度，求平均
hgt = f2.z.sel(expver=1, level=500).groupby('time.year').mean(dim='time', skipna=True)
...
plt.savefig(r'F:\6_Scientific_Research\3_Teleconnection\2_Picture\6_1019Problem\1_Tel_connection\Cor_Cir_GHT-500hPa.png')
